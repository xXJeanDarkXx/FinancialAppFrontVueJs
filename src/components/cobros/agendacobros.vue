...
<el-table v-loading="loading" :data="data" style="width: 100%">
        <el-table-column @click="viewDetails(scope.row.expedientesId)" prop="Nombre" label="Nombre" sortable>
...
<el-dialog
  ...
  :data="dataViewDetails">
  <span></span>
  <el-form v-loading="loadingviewDetails" :model="formCategoria" :rules="rulesCategorias" ref="ruleFormCategorias">
